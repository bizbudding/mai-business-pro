...
define( 'CHILD_THEME_NAME', 'Mai Business Theme' );
...
function maitheme_enqueue_fonts() {
	wp_enqueue_style( 'maitheme-google-fonts', 'https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Source+Sans+Pro:600,700&display=swap', array(), CHILD_THEME_VERSION );
}
