...
define( 'CHILD_THEME_NAME', 'Mai Business Pro' );
...
function maip_enqueue_fonts() {
	wp_enqueue_style( 'maip-google-fonts', '//fonts.googleapis.com/css?family=Merriweather:300,300i,400,400i,700,700i|Montserrat:600,600i,700,700i,800,800i,900,900i', array(), CHILD_THEME_VERSION );
}
